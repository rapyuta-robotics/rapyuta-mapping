    ...
    for bag_name in sys.argv[1:]:
        ...
        for topic, msg, t in rosbag.Bag(bag_name).read_messages():
            ...
            if topic == "/tf" and msg.transforms:
                ...
                outbag.write(topic, msg,  start_time + (msg.transforms[0].header.stamp - real_start_time))
            else:
                msg.header.frame_id = prefix + msg.header.frame_id
                outbag.write(prefix + topic, msg, start_time + (msg.header.stamp - real_start_time))
