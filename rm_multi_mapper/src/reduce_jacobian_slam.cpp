...
reduce_jacobian_slam::reduce_jacobian_slam(
...
void reduce_jacobian_slam::add_icp_measurement(int i, int j) {
...
void reduce_jacobian_slam::add_rgbd_measurement(int i, int j) {
...
void reduce_jacobian_slam::add_floor_measurement(int i) {
